//simashaji/apps/web/src/components/AuthComponents.tsx
"use client";
...
// Header Component untuk layout yang sama
interface AuthHeaderProps {
  title: string;
  subtitle?: string;
  logoSrc: string | StaticImport; // path publik atau import statis
}

export function AuthHeader({ title, subtitle, logoSrc }: AuthHeaderProps) {
  return (
